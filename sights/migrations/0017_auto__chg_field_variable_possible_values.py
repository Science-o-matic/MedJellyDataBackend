...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Variable.possible_values'
        db.alter_column(u'sights_variable', 'possible_values', self.gf('json_field.fields.JSONField')(null=True))

    def backwards(self, orm):

        # Changing field 'Variable.possible_values'
        db.alter_column(u'sights_variable', 'possible_values', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    models = {
        ...
        u'sights.variable': {
            ...
            'possible_values': ('json_field.fields.JSONField', [], {'default': "u'null'", 'null': 'True', 'blank': 'True'}),
