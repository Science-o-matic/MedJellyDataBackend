...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MedJellyBeach'
        db.create_table(u'sights_medjellybeach', (
            ('id', self.gf('django.db.models.fields.IntegerField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=300)),
            ('town', self.gf('django.db.models.fields.CharField')(max_length=300)),
        ))
        db.send_create_signal(u'sights', ['MedJellyBeach'])


    def backwards(self, orm):
        # Deleting model 'MedJellyBeach'
        db.delete_table(u'sights_medjellybeach')
