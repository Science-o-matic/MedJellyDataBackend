...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Variable.api_warning_level'
        db.add_column(u'sights_variable', 'api_warning_level',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Variable.api_warning_level'
        db.delete_column(u'sights_variable', 'api_warning_level')
