...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BeachVariable.description'
        db.delete_column(u'sights_beachvariable', 'description')

        # Deleting field 'BeachVariable.type'
        db.delete_column(u'sights_beachvariable', 'type')

        # Deleting field 'BeachVariable.measure_unit'
        db.delete_column(u'sights_beachvariable', 'measure_unit_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'BeachVariable.description'
        raise RuntimeError("Cannot reverse this migration. 'BeachVariable.description' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'BeachVariable.type'
        raise RuntimeError("Cannot reverse this migration. 'BeachVariable.type' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'BeachVariable.measure_unit'
        raise RuntimeError("Cannot reverse this migration. 'BeachVariable.measure_unit' and its values cannot be restored.")
