...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BeachVariable.variable'
        db.add_column(u'sights_beachvariable', 'variable',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sights.Variable'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BeachVariable.variable'
        db.delete_column(u'sights_beachvariable', 'variable_id')
