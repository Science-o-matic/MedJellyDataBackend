...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Variable.description'
        db.alter_column(u'sights_variable', 'description', self.gf('django.db.models.fields.CharField')(max_length=300))

        # Changing field 'Variable.type'
        db.alter_column(u'sights_variable', 'type', self.gf('django.db.models.fields.CharField')(max_length=300))

    def backwards(self, orm):

        # Changing field 'Variable.description'
        db.alter_column(u'sights_variable', 'description', self.gf('django.db.models.fields.CharField')(max_length=1000))

        # Changing field 'Variable.type'
        db.alter_column(u'sights_variable', 'type', self.gf('django.db.models.fields.CharField')(max_length=1000))
