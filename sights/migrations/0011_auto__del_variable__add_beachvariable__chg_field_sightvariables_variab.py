...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'BeachVariable'
        db.create_table(u'sights_beachvariable', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('beach', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sights.Beach'])),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sights.VariablesGroup'], null=True, blank=True)),
            ...
            ('measure_unit', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sights.MeasureUnit'])),
        ))
        db.send_create_signal(u'sights', ['BeachVariable'])


        # Changing field 'SightVariables.variable'
        db.alter_column(u'sights_sightvariables', 'variable_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sights.BeachVariable']))
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'sights_variable', (
            ...
            ('description', self.gf('django.db.models.fields.CharField')(max_length=300)),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=300)),
            ('measure_unit', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sights.MeasureUnit'])),
            ('beach', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sights.Beach'])),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'sights', ['Variable'])

        # Deleting model 'BeachVariable'
        db.delete_table(u'sights_beachvariable')
