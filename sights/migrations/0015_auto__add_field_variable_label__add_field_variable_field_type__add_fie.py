...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Variable.label'
        db.add_column(u'sights_variable', 'label',
                      self.gf('django.db.models.fields.CharField')(max_length=300, null=True),
                      keep_default=False)

        # Adding field 'Variable.field_type'
        db.add_column(u'sights_variable', 'field_type',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)

        # Adding field 'Variable.widget'
        db.add_column(u'sights_variable', 'widget',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)

        # Adding field 'Variable.possible_values'
        db.add_column(u'sights_variable', 'possible_values',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Variable.label'
        db.delete_column(u'sights_variable', 'label')

        # Deleting field 'Variable.field_type'
        db.delete_column(u'sights_variable', 'field_type')

        # Deleting field 'Variable.widget'
        db.delete_column(u'sights_variable', 'widget')

        # Deleting field 'Variable.possible_values'
        db.delete_column(u'sights_variable', 'possible_values')
    ...
    models = {
        ...
        u'sights.variable': {
            ...
            'widget': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True'})
        },
