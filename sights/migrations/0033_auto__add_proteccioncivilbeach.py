...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProteccionCivilBeach'
        db.create_table(u'sights_proteccioncivilbeach', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('code', self.gf('django.db.models.fields.CharField')(max_length=300)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=300)),
            ('town', self.gf('django.db.models.fields.CharField')(max_length=300)),
        ))
        db.send_create_signal(u'sights', ['ProteccionCivilBeach'])


    def backwards(self, orm):
        # Deleting model 'ProteccionCivilBeach'
        db.delete_table(u'sights_proteccioncivilbeach')
