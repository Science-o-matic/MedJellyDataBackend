...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BeachVariable.group'
        db.delete_column(u'sights_beachvariable', 'group_id')


    def backwards(self, orm):
        # Adding field 'BeachVariable.group'
        db.add_column(u'sights_beachvariable', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sights.VariablesGroup'], null=True, blank=True),
                      keep_default=False)
