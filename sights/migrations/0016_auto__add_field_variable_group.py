...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Variable.group'
        db.add_column(u'sights_variable', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sights.VariablesGroup'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Variable.group'
        db.delete_column(u'sights_variable', 'group_id')
