...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sight.api_sent'
        db.add_column(u'sights_sight', 'api_sent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Sight.api_sent_timestamp'
        db.add_column(u'sights_sight', 'api_sent_timestamp',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Sight.ftp_sent'
        db.add_column(u'sights_sight', 'ftp_sent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Sight.ftp_sent_timestamp'
        db.add_column(u'sights_sight', 'ftp_sent_timestamp',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sight.api_sent'
        db.delete_column(u'sights_sight', 'api_sent')

        # Deleting field 'Sight.api_sent_timestamp'
        db.delete_column(u'sights_sight', 'api_sent_timestamp')

        # Deleting field 'Sight.ftp_sent'
        db.delete_column(u'sights_sight', 'ftp_sent')

        # Deleting field 'Sight.ftp_sent_timestamp'
        db.delete_column(u'sights_sight', 'ftp_sent_timestamp')
