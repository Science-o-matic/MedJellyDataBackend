...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Beach.proteccion_civil_api_id'
        db.add_column(u'sights_beach', 'proteccion_civil_api_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Beach.proteccion_civil_api_id'
        db.delete_column(u'sights_beach', 'proteccion_civil_api_id')
    ...
    models = {
        ...
        u'sights.beach': {
            ...
            'proteccion_civil_api_id': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
