...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for beach in orm.Beach.objects.all():
            try:
                proteccion_civil_beach = orm.ProteccionCivilBeach.objects.get(
                    code=beach.proteccion_civil_api_id
                    )
            except orm.ProteccionCivilBeach.DoesNotExist:
                proteccion_civil_beach = None

            if proteccion_civil_beach:
                beach.proteccion_civil_beaches.add(proteccion_civil_beach)
                beach.save()
