...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReportingClient.last_import_date'
        db.add_column(u'sights_reportingclient', 'last_import_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReportingClient.last_import_date'
        db.delete_column(u'sights_reportingclient', 'last_import_date')
