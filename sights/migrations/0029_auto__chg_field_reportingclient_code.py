...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ReportingClient.code'
        db.alter_column(u'sights_reportingclient', 'code', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))

    def backwards(self, orm):

        # Changing field 'ReportingClient.code'
        db.alter_column(u'sights_reportingclient', 'code', self.gf('django.db.models.fields.CharField')(default='APP', max_length=300))
