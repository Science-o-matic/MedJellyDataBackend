...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SightVariables.value'
        db.alter_column(u'sights_sightvariables', 'value', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'SightVariables.value'
        db.alter_column(u'sights_sightvariables', 'value', self.gf('django.db.models.fields.FloatField')())
