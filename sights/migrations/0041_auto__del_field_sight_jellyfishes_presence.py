...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Sight.jellyfishes_presence'
        db.delete_column(u'sights_sight', 'jellyfishes_presence')


    def backwards(self, orm):
        # Adding field 'Sight.jellyfishes_presence'
        db.add_column(u'sights_sight', 'jellyfishes_presence',
