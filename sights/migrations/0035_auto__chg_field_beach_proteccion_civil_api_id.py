...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Beach.proteccion_civil_api_id'
        db.alter_column(u'sights_beach', 'proteccion_civil_api_id', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))

    def backwards(self, orm):

        # Changing field 'Beach.proteccion_civil_api_id'
        db.alter_column(u'sights_beach', 'proteccion_civil_api_id', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        u'sights.beach': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'medjelly_api_id': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '1000'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sights.BeachOwner']"}),
            'proteccion_civil_api_id': ('django.db.models.fields.CharField', [], {'max_length': '300', 'null': 'True'}),
