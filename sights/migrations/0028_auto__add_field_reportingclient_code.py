...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReportingClient.code'
        db.add_column(u'sights_reportingclient', 'code',
                      self.gf('django.db.models.fields.CharField')(default='APP', max_length=300),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReportingClient.code'
        db.delete_column(u'sights_reportingclient', 'code')
