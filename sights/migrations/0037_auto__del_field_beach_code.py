...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Beach.code'
        db.delete_column(u'sights_beach', 'code')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Beach.code'
        raise RuntimeError("Cannot reverse this migration. 'Beach.code' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Beach.code'
        db.add_column(u'sights_beach', 'code',
