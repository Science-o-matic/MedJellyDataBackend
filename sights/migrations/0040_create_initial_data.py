...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        orm.ReportingClient.objects.get_or_create(pk=1, name="Móvil")
        orm.ReportingClient.objects.get_or_create(pk=2, name="Protección Civíl")


    def backwards(self, orm):
        "Write your backwards methods here."
        raise CommandError("This migration cannot be reversed")
